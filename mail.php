...
$mailBody = " <div><h2>Enquiry Details</h2><table border='1'>
    <tbody><tr><th>Name</th><td>" . $name . "</td></tr>
...
try {
    ...
    $mail->Password   = 'jmfrluioasgikssm';                               //SMTP password
    ...
    // }else{
    //     header("Location: saltee-splendora-brochure.pdf");
    // }
